...
<input type="hidden" name="cashier" value="<?php echo $user_data['first'] ?>" />
<p>Customer Type</p><input type="text" name="pt" value="<?php echo $_GET['id']; ?>" required readonly/>
<p>Invoice Number</p><input type="text" name="invoice" value="<?php echo $_GET['invoice']; ?>" required><br>
...
<option value="<?php echo $row['product_id'];?>"
                  ...
                  <?php echo $row['product_code']; ?> - <?php echo $row['gen_name']; ?> - <?php echo $row['product_name']; ?> | Quality: <?php echo $row['qty']; ?> | Price:Gh <?php echo $row['price']; ?></option>
	<?php
				}
			?>
</select>
...
<table class="table table-bordered" id="resultTable" data-responsive="table">
  ...
  <?php endif; ?>
			<td width="90"><a href="itemturn.php?id=<?php echo $row['transaction_id']; ?>&invoice=<?php echo $_GET['invoice']; ?>&dle=<?php echo $_GET['id']; ?>&qty=<?php echo $row['qty'];?>&code=<?php echo $row['product'];?>"><button class="btn btn-mini btn-warning"><i class=""></i> Return Item </button></a></td>
			</tr>
			<?php
				}
			?>
